...
type OversightCommitteeContractConfig struct {
	...
	// InitialMembers is a list of non-voting members to be added to the
	// TRUSTED_CIRCLE upon creation
	InitialMembers []string `protobuf:"bytes,7,rep,name=initial_members,json=initialMembers,proto3" json:"initial_members,omitempty"`
	// DenyListContractAddress is an optional cw4 contract with list of addresses
	// denied to be part of TrustedCircle
	DenyListContractAddress string `protobuf:"bytes,8,opt,name=deny_list_contract_address,json=denyListContractAddress,proto3" json:"deny_list_contract_address,omitempty"`
	// DisableEdit If true, no further adjustments may happen.
	DisableEdit bool `protobuf:"varint,9,opt,name=disable_edit,json=disableEdit,proto3" json:"disable_edit,omitempty"`
}
...
func (m *OversightCommitteeContractConfig) GetInitialMembers() []string {
	if m != nil {
...
func (m *OversightCommitteeContractConfig) GetDisableEdit() bool {
	if m != nil {
		return m.DisableEdit
	}
	return false
}
...
var fileDescriptor_a165193bab811d9d = []byte{
	...
	,
}
...
func (m *OversightCommitteeContractConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.InitialMembers) > 0 {
		for iNdEx := len(m.InitialMembers) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintGenesis(dAtA, i, uint64(len(m.InitialMembers[iNdEx])))
			i--
			dAtA[i] = 0x3a
		}
	}
...
func (m *OversightCommitteeContractConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DisableEdit", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
