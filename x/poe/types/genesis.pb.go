...
type GenesisState struct {
	...
	// seed mode.
	Contracts []PoEContract `protobuf:"bytes,3,rep,name=contracts,proto3" json:"contracts,omitempty"`
	// SeedContracts when enabled stores and instantiates the Proof of Engagement
	// contracts on the chain.
	SeedContracts *SeedContracts `protobuf:"bytes,2,opt,name=seed_contracts,json=seedContracts,proto3" json:"seed_contracts,omitempty"`
}
...
var fileDescriptor_a165193bab811d9d = []byte{
	...
	,
}
...
func (m *ValsetContractConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x22
	n12, err12 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.EpochLength, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.EpochLength):])
	if err12 != nil {
		return 0, err12
	}
	i -= n12
...
func (m *EngagementContractConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n13, err13 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.Halflife, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.Halflife):])
	if err13 != nil {
		return 0, err13
	}
	i -= n13
...
func (m *ArbiterPoolContractConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n18, err18 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.WaitingPeriod, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.WaitingPeriod):])
	if err18 != nil {
		return 0, err18
	}
	i -= n18
	i = encodeVarintGenesis(dAtA, i, uint64(n18))
	i--
	dAtA[i] = 0x32
	{
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.SeedContracts == nil {
				m.SeedContracts = &SeedContracts{}
			}
			if err := m.SeedContracts.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
