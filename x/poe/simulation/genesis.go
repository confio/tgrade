...
func RandomizedGenState(simState *module.SimulationState) {
	...
	poeGenesis.GenTxs = genTxs
	poeGenesis.SystemAdminAddress = simState.Accounts[len(simState.Accounts)-1].Address.String() // use a non validator account
	poeGenesis.Engagement = engagements
	poeGenesis.BondDenom = defaultDenom
	poeGenesis.OversightCommunityMembers = ocMembers
	poeGenesis.ArbiterPoolMembers = apMembers
	poeGenesis.ArbiterPoolContractConfig.EscrowAmount.Denom = poeGenesis.BondDenom
	poeGenesis.ArbiterPoolContractConfig.DisputeCost.Denom = poeGenesis.BondDenom
	poeGenesis.ValsetContractConfig.EpochReward.Denom = poeGenesis.BondDenom
	poeGenesis.OversightCommitteeContractConfig.EscrowAmount.Denom = poeGenesis.BondDenom
