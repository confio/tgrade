...
func TestInitGenesis(t *testing.T) {
	...
	app := NewAppModule(example.EncodingConfig.Marshaler, example.PoEKeeper, example.TWasmKeeper, deliverTXFn, example.EncodingConfig.TxConfig, example.TWasmKeeper.GetContractKeeper())
