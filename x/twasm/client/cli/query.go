...
func GetCmdShowPrivilegedContracts() *cobra.Command {
	cmd := &cobra.Command{
		Use:     "list-privileged-contracts-by-type <privilege_type>",
		...
		Aliases: []string{"privilege-contracts-by-type", "privileged-contract-by-type", "lpct"},
