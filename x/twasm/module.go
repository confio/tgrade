...
func (b AppModuleBasic) ValidateGenesis(marshaler codec.JSONMarshaler, config client.TxEncodingConfig, message json.RawMessage) error {
	...
	return wasmtypes.ValidateGenesis(data)
}
...
func NewAppModule(cdc codec.Marshaler, keeper *wasmkeeper.Keeper, validatorSetSource wasmkeeper.ValidatorSetSource) AppModule {
	return AppModule{
...
func (am AppModule) RegisterServices(cfg module.Configurator) {
	...
	wasmtypes.RegisterQueryServer(cfg.QueryServer(), wasmkeeper.NewQuerier(am.keeper))
}

func (am AppModule) LegacyQuerierHandler(amino *codec.LegacyAmino) sdk.Querier {
	return wasmkeeper.NewLegacyQuerier(am.keeper)
}
...
func (am AppModule) Route() sdk.Route {
	return sdk.NewRoute(types.RouterKey, wasm.NewHandler(am.keeper))
}
...
func (am AppModule) InitGenesis(ctx sdk.Context, cdc codec.JSONMarshaler, data json.RawMessage) []abci.ValidatorUpdate {
	...
	validators, err := wasmkeeper.InitGenesis(ctx, am.keeper, genesisState, am.validatorSetSource, am.Route().Handler())
	if err != nil {
		panic(err)
	}
	return validators
...
func AddModuleInitFlags(startCmd *cobra.Command) {
	defaults := wasmtypes.DefaultWasmConfig()
...
func ReadWasmConfig(opts servertypes.AppOptions) (wasmtypes.WasmConfig, error) {
